I had some problems with php in github so I tested it in xampp server, ther's a config in files: php.ini and senmail.ini and screenshots of my programms results.
